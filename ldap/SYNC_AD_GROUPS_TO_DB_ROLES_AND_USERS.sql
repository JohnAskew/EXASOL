...
--/
--====================================
CREATE OR REPLACE LUA SCRIPT EXA_TOOLBOX.SYNC_AD_GROUPS_TO_DB_ROLES_AND_USERS(LDAP_CONNECTION, GROUP_ATTRIBUTE, USER_ATTRIBUTE, EXECUTION_MODE, OPT_SEND_EMAIL, OPT_WRITE_AUDIT) RETURNS TABLE AS
--====================================
/*--------------------------------------
-- NOTES for Usage
---------------------------------------
...
---------------------------------------
--
EXECUTE SCRIPT EXA_TOOLBOX.SYNC_AD_GROUPS_TO_DB_ROLES_AND_USERS('TEST_LDAP_WEB','uniqueMember','uid','EXECUTE','ON' ,'ON');
--
